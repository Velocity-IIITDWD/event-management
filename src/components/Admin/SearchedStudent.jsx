  ...
  return (
    <div className='px-5'>
      ...
      >
        ...
        <button
          type='submit'
          className='text-white bg-blue-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center block md:inline my-2 md:my-0 md:mr-3'
        >
          Update
        </button>
